...
def train_and_validate(model_name, train_texts, train_labels, val_texts, val_labels, epochs=3, lr=2e-5, save_path= None):
    ...
    # model.load_state_dict(torch.load('./t5_model_add_validation_epoch_8.pt')) # using both dataset (IMDB + SST2)
...
data_name = 'IMDB' # IMDB or SST2_IMDB

# Fine-tuning 및 모델 저장
save_path = os.path.join(base_path,f'finetuning/{data_name}/')
save_path = "/home/tjddms9376/DL/finetuning/IMDB/"
